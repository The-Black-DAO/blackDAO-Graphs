...
import { BlackDaoERC20 } from '../../generated/sBlackDaoERC20V3/BlackDaoERC20';
import { sBlackDaoERC20V3 } from '../../generated/sBlackDaoERC20V3/sBlackDaoERC20V3';
import { ERC20 } from '../../generated/sBlackDaoERC20V3/ERC20';
import { UniswapV2Pair } from '../../generated/sBlackDaoERC20V3/UniswapV2Pair';
import { BlackDaoStakingV3 } from '../../generated/sBlackDaoERC20V3/BlackDaoStakingV3';
import { Distributor } from '../../generated/sBlackDaoERC20V3/Distributor';

import { ProtocolMetric, Transaction } from '../../generated/schema'
import { ERC20DAI_CONTRACT, WETH_ERC20_CONTRACT, STAKING_CONTRACT_V3, TREASURY_ADDRESS_V3, SOHM_ERC20_CONTRACTV3, OHMV2_ERC20_CONTRACT, DAO_WALLET, SUSHI_OHMETH_PAIRV2, SUSHI_OHMDAI_PAIRV2, DISTRIBUTOR_CONTRACT_V2 } from './Constants';
import { SUSHI_OHMDAI_PAIRV2_BLOCK, SUSHI_OHMETH_PAIRV2_BLOCK} from './Constants'
...
function getTotalSupply(): BigDecimal{
        let ohm_contract = BlackDaoERC20.bind(Address.fromString(OHMV2_ERC20_CONTRACT))
...
function getSohmSupply(): BigDecimal{
    ...
    let sohm_contract_v3 = sBlackDaoERC20V3.bind(Address.fromString(SOHM_ERC20_CONTRACTV3))
...
function getMV_RFV(block: BigInt): BigDecimal[]{
    ...
    let lpValue = ohmdai_value.plus(ohmeth_value)
    let rfvLpValue = ohmdai_rfv.plus(ohmeth_rfv)
...
function getNextOHMRebase(): BigDecimal{
        let staking_contract_v3 = BlackDaoStakingV3.bind(Address.fromString(STAKING_CONTRACT_V3))
...
function getAPY_Rebase(sOHM: BigDecimal, distributedOHM: BigDecimal): BigDecimal[]{
    ...
    let currentAPYdecimal: BigDecimal = new BigDecimal(BigInt.fromI32(0));

    if(sOHM.gt(new BigDecimal(BigInt.fromI32(0))) && distributedOHM.gt(new BigDecimal(BigInt.fromI32(0))) ){
...
export function updateProtocolMetrics(transaction: Transaction): void{
    ...
    pm.treasuryWETHMarketValue = mv_rfv[5]
    pm.treasuryOhmDaiPOL = mv_rfv[6]
    pm.treasuryOhmEthPOL = mv_rfv[7]
    pm.treasuryStableBacking = mv_rfv[8]
    pm.treasuryVolatileBacking = mv_rfv[9]
    pm.treasuryTotalBacking = mv_rfv[10]
    pm.treasuryLPValue = mv_rfv[11]

    // // Rebase rewards, APY, rebase
    pm.nextDistributedOhm = getNextOHMRebase() 
    let apy_rebase = getAPY_Rebase(pm.sOhmCirculatingSupply, pm.nextDistributedOhm)         // this causes issues comment run then uncomment
    pm.currentAPY = apy_rebase[0].notEqual(BigDecimal.zero()) ? apy_rebase[0] : BigDecimal.fromString("0")
    pm.nextEpochRebase = apy_rebase[1].notEqual(BigDecimal.zero()) ? apy_rebase[1] : BigDecimal.fromString("0")
